        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body " style="background-color: rgb(39,162,212);">
                    <a href="http://localhost/elearning-system/gestion-employes" class="btn btn-light mb-2"><i class="fa fa-home"></i></a>
                    <form method="post">
...
<script src="/elearning-system/public/js/password-view.js"></script>
