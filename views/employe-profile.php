        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body" style="background-color: rgb(39,162,212);">
                    <a href="http://localhost/elearning-system/gestion-employes" class="btn btn-outline-light mb-2"><i class="fa fa-home"></i></a>
                    <a href="http://localhost/elearning-system/employe-change-password" class="btn btn-light mb-2">Change Password</i></a>
                    <form method="post">
